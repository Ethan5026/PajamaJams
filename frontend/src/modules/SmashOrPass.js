...
import '../styles/SmashOrPassStyles.css'


export const SmashOrPass = ({setViewer}) => {

    function changeQuestionText() {

        const questionText = document.getElementById('questionText');
    
        fetch("http://127.0.0.1:4000/smash-or-pass")
...
<header>
    ...
    <main>
        ...
        <h1 class="unselectable" style={{width: '100%', textAlign: 'center'}}>Smash or Pass</h1>
        <div id="questionBox" class="box">
            <p id="questionText" style={{fontSize: '50pt', textAlign: 'center'}}>Click on the New Prompt button...</p>
        </div>
    ...
    <div id="aboutDropdown">
        <p>How to Play: Smash or Pass</p>
        <p>Smash or Pass is a classic party game that challenges a participant to decide whether they would 'Smash' or 'Pass' a particular person.</p>
        <p>The participant will be prompted with a person and they must choose if they'd 'Smash' or 'Pass'</p>
